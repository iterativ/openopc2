...
class IOPCAutoServer(DispatchBaseClass):
	...
	def GetItemProperties(self, ItemID=defaultNamedNotOptArg, Count=defaultNamedNotOptArg, PropertyIDs=defaultNamedNotOptArg, PropertyValues=pythoncom.Missing
			, Errors=pythoncom.Missing):
		'Returns the properties for the specified item.'
		return self._ApplyTypes_(1610743832, 1, (24, 0), ((8, 1), (3, 1), (24579, 1), (24588, 2), (24579, 2)), 'GetItemProperties', None,ItemID
	...
	def LookupItemIDs(self, ItemID=defaultNamedNotOptArg, Count=defaultNamedNotOptArg, PropertyIDs=defaultNamedNotOptArg, NewItemIDs=pythoncom.Missing
			, Errors=pythoncom.Missing):
		'Returns the item ids for the specified properties.'
		return self._ApplyTypes_(1610743833, 1, (24, 0), ((8, 1), (3, 1), (24579, 1), (24584, 2), (24579, 2)), 'LookupItemIDs', None,ItemID
	...
	def QueryAvailableProperties(self, ItemID=defaultNamedNotOptArg, Count=pythoncom.Missing, PropertyIDs=pythoncom.Missing, Descriptions=pythoncom.Missing
			, DataTypes=pythoncom.Missing):
		'Returns the properties available for the specified item.'
		return self._ApplyTypes_(1610743831, 1, (24, 0), ((8, 1), (16387, 2), (24579, 2), (24584, 2), (24578, 2)), 'QueryAvailableProperties', None,ItemID
...
class IOPCGroup(DispatchBaseClass):
	...
	def AsyncRead(self, NumItems=defaultNamedNotOptArg, ServerHandles=defaultNamedNotOptArg, Errors=pythoncom.Missing, TransactionID=defaultNamedNotOptArg
			, CancelID=pythoncom.Missing):
		return self._ApplyTypes_(1610743830, 1, (24, 0), ((3, 1), (24579, 1), (24579, 2), (3, 1), (16387, 2)), 'AsyncRead', None,NumItems
			, ServerHandles, Errors, TransactionID, CancelID)

	def AsyncRefresh(self, Source=defaultNamedNotOptArg, TransactionID=defaultNamedNotOptArg, CancelID=pythoncom.Missing):
		return self._ApplyTypes_(1610743832, 1, (24, 0), ((2, 1), (3, 1), (16387, 2)), 'AsyncRefresh', None,Source
			, TransactionID, CancelID)

	def AsyncWrite(self, NumItems=defaultNamedNotOptArg, ServerHandles=defaultNamedNotOptArg, Values=defaultNamedNotOptArg, Errors=pythoncom.Missing
			, TransactionID=defaultNamedNotOptArg, CancelID=pythoncom.Missing):
		return self._ApplyTypes_(1610743831, 1, (24, 0), ((3, 1), (24579, 1), (24588, 1), (24579, 2), (3, 1), (16387, 2)), 'AsyncWrite', None,NumItems
			, ServerHandles, Values, Errors, TransactionID, CancelID
			)

	def SyncRead(self, Source=defaultNamedNotOptArg, NumItems=defaultNamedNotOptArg, ServerHandles=defaultNamedNotOptArg, Values=pythoncom.Missing
			, Errors=pythoncom.Missing, Qualities=pythoncom.Missing, TimeStamps=pythoncom.Missing):
		return self._ApplyTypes_(1610743828, 1, (24, 0), ((2, 1), (3, 1), (24579, 1), (24588, 2), (24579, 2), (16396, 18), (16396, 18)), 'SyncRead', None,Source
			, NumItems, ServerHandles, Values, Errors, Qualities
			, TimeStamps)

	def SyncWrite(self, NumItems=defaultNamedNotOptArg, ServerHandles=defaultNamedNotOptArg, Values=defaultNamedNotOptArg, Errors=pythoncom.Missing):
		return self._ApplyTypes_(1610743829, 1, (24, 0), ((3, 1), (24579, 1), (24588, 1), (24579, 2)), 'SyncWrite', None,NumItems
...
class OPCItem(DispatchBaseClass):
	...
	def Read(self, Source=defaultNamedNotOptArg, Value=pythoncom.Missing, Quality=pythoncom.Missing, TimeStamp=pythoncom.Missing):
		return self._ApplyTypes_(1610743825, 1, (24, 0), ((2, 1), (16396, 18), (16396, 18), (16396, 18)), 'Read', None,Source
...
class OPCItems(DispatchBaseClass):
	...
	def AddItems(self, NumItems=defaultNamedNotOptArg, ItemIDs=defaultNamedNotOptArg, ClientHandles=defaultNamedNotOptArg, ServerHandles=pythoncom.Missing
		...
		return self._ApplyTypes_(1610743820, 1, (24, 0), ((3, 1), (24584, 1), (24579, 1), (24579, 2), (24579, 2), (12, 17), (12, 17)), 'AddItems', None,NumItems
	...
	def SetActive(self, NumItems=defaultNamedNotOptArg, ServerHandles=defaultNamedNotOptArg, ActiveState=defaultNamedNotOptArg, Errors=pythoncom.Missing):
		'Set the active state of OPCItem objects'
		return self._ApplyTypes_(1610743823, 1, (24, 0), ((3, 1), (24579, 1), (11, 1), (24579, 2)), 'SetActive', None,NumItems
			, ServerHandles, ActiveState, Errors)

	def SetClientHandles(self, NumItems=defaultNamedNotOptArg, ServerHandles=defaultNamedNotOptArg, ClientHandles=defaultNamedNotOptArg, Errors=pythoncom.Missing):
		'Set the Client handles of OPCItem objects'
		return self._ApplyTypes_(1610743824, 1, (24, 0), ((3, 1), (24579, 1), (24579, 1), (24579, 2)), 'SetClientHandles', None,NumItems
			, ServerHandles, ClientHandles, Errors)

	def SetDataTypes(self, NumItems=defaultNamedNotOptArg, ServerHandles=defaultNamedNotOptArg, RequestedDataTypes=defaultNamedNotOptArg, Errors=pythoncom.Missing):
		'Set the Data Types of OPCItem objects'
		return self._ApplyTypes_(1610743825, 1, (24, 0), ((3, 1), (24579, 1), (24579, 1), (24579, 2)), 'SetDataTypes', None,NumItems
			, ServerHandles, RequestedDataTypes, Errors)

	def Validate(self, NumItems=defaultNamedNotOptArg, ItemIDs=defaultNamedNotOptArg, Errors=pythoncom.Missing, RequestedDataTypes=defaultNamedOptArg
			, AccessPaths=defaultNamedOptArg):
		'Validates a set of item ids without adding them to the collection.'
		return self._ApplyTypes_(1610743822, 1, (24, 0), ((3, 1), (24584, 1), (24579, 2), (12, 17), (12, 17)), 'Validate', None,NumItems
...
IOPCActivator_vtables_ = [
	(( 'Attach' , 'Server' , 'ProgID' , 'NodeName' , 'ppWrapper' , 
			 ), 1610743808, (1610743808, (), [ (13, 1, None, None) , (8, 1, None, None) , (12, 17, None, None) , (16393, 10, None, "IID('{CAB0C53A-E6A6-4223-8AA2-14CAD6F14A3E}')") , ], 1 , 1 , 4 , 1 , 28 , (3, 0, None, None) , 0 , )),
]

IOPCAutoServer_vtables_dispatch_ = 1
IOPCAutoServer_vtables_ = [
	(( 'StartTime' , 'StartTime' , ), 1610743808, (1610743808, (), [ (16391, 10, None, None) , ], 1 , 2 , 4 , 0 , 28 , (3, 0, None, None) , 0 , )),
	(( 'CurrentTime' , 'CurrentTime' , ), 1610743809, (1610743809, (), [ (16391, 10, None, None) , ], 1 , 2 , 4 , 0 , 32 , (3, 0, None, None) , 0 , )),
	(( 'LastUpdateTime' , 'LastUpdateTime' , ), 1610743810, (1610743810, (), [ (16391, 10, None, None) , ], 1 , 2 , 4 , 0 , 36 , (3, 0, None, None) , 0 , )),
	(( 'MajorVersion' , 'MajorVersion' , ), 1610743811, (1610743811, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 40 , (3, 0, None, None) , 0 , )),
	(( 'MinorVersion' , 'MinorVersion' , ), 1610743812, (1610743812, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 44 , (3, 0, None, None) , 0 , )),
	(( 'BuildNumber' , 'BuildNumber' , ), 1610743813, (1610743813, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 48 , (3, 0, None, None) , 0 , )),
	(( 'VendorInfo' , 'VendorInfo' , ), 1610743814, (1610743814, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( 'ServerState' , 'ServerState' , ), 1610743815, (1610743815, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
	(( 'ServerName' , 'ServerName' , ), 1610743816, (1610743816, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
	(( 'ServerNode' , 'ServerNode' , ), 1610743817, (1610743817, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 64 , (3, 0, None, None) , 0 , )),
	(( 'ClientName' , 'ClientName' , ), 1610743818, (1610743818, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 68 , (3, 0, None, None) , 0 , )),
	(( 'ClientName' , 'ClientName' , ), 1610743818, (1610743818, (), [ (8, 1, None, None) , ], 1 , 4 , 4 , 0 , 72 , (3, 0, None, None) , 0 , )),
	(( 'LocaleID' , 'LocaleID' , ), 1610743820, (1610743820, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 76 , (3, 0, None, None) , 0 , )),
	(( 'LocaleID' , 'LocaleID' , ), 1610743820, (1610743820, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 80 , (3, 0, None, None) , 0 , )),
	(( 'Bandwidth' , 'Bandwidth' , ), 1610743822, (1610743822, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 84 , (3, 0, None, None) , 0 , )),
	(( 'OPCGroups' , 'ppGroups' , ), 0, (0, (), [ (16397, 10, None, "IID('{3088F151-40A7-4B34-9384-56F1BC1DEE9C}')") , ], 1 , 2 , 4 , 0 , 88 , (3, 0, None, None) , 0 , )),
	(( 'PublicGroupNames' , 'PublicGroups' , ), 1610743824, (1610743824, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 92 , (3, 0, None, None) , 0 , )),
	(( 'GetOPCServers' , 'Node' , 'OPCServers' , ), 1610743825, (1610743825, (), [ (12, 17, None, None) , 
			 (16396, 10, None, None) , ], 1 , 1 , 4 , 1 , 96 , (3, 0, None, None) , 0 , )),
	(( 'Connect' , 'ProgID' , 'Node' , ), 1610743826, (1610743826, (), [ (8, 1, None, None) , 
			 (12, 17, None, None) , ], 1 , 1 , 4 , 1 , 100 , (3, 0, None, None) , 0 , )),
	(( 'Disconnect' , ), 1610743827, (1610743827, (), [ ], 1 , 1 , 4 , 0 , 104 , (3, 0, None, None) , 0 , )),
	(( 'CreateBrowser' , 'ppBrowser' , ), 1610743828, (1610743828, (), [ (16393, 10, None, "IID('{E79CC822-741F-4D1E-974E-1CE76B155FD6}')") , ], 1 , 1 , 4 , 0 , 108 , (3, 0, None, None) , 0 , )),
	(( 'GetErrorString' , 'ErrorCode' , 'ErrorString' , ), 1610743829, (1610743829, (), [ (3, 1, None, None) , 
			 (16392, 10, None, None) , ], 1 , 1 , 4 , 0 , 112 , (3, 0, None, None) , 0 , )),
	(( 'QueryAvailableLocaleIDs' , 'LocaleIDs' , ), 1610743830, (1610743830, (), [ (16396, 10, None, None) , ], 1 , 1 , 4 , 0 , 116 , (3, 0, None, None) , 0 , )),
	(( 'QueryAvailableProperties' , 'ItemID' , 'Count' , 'PropertyIDs' , 'Descriptions' , 
			 ...
			 (24584, 2, None, None) , (24578, 2, None, None) , ], 1 , 1 , 4 , 0 , 120 , (3, 0, None, None) , 0 , )),
	(( 'GetItemProperties' , 'ItemID' , 'Count' , 'PropertyIDs' , 'PropertyValues' , 
			 ...
			 (24588, 2, None, None) , (24579, 2, None, None) , ], 1 , 1 , 4 , 0 , 124 , (3, 0, None, None) , 0 , )),
	(( 'LookupItemIDs' , 'ItemID' , 'Count' , 'PropertyIDs' , 'NewItemIDs' , 
			 ...
			 (24584, 2, None, None) , (24579, 2, None, None) , ], 1 , 1 , 4 , 0 , 128 , (3, 0, None, None) , 0 , )),
]

IOPCGroup_vtables_dispatch_ = 1
IOPCGroup_vtables_ = [
	(( 'Parent' , 'ppParent' , ), 1610743808, (1610743808, (), [ (16393, 10, None, "IID('{CAB0C53A-E6A6-4223-8AA2-14CAD6F14A3E}')") , ], 1 , 2 , 4 , 0 , 28 , (3, 0, None, None) , 0 , )),
	(( 'Name' , 'Name' , ), 1610743809, (1610743809, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 32 , (3, 0, None, None) , 0 , )),
	(( 'Name' , 'Name' , ), 1610743809, (1610743809, (), [ (8, 1, None, None) , ], 1 , 4 , 4 , 0 , 36 , (3, 0, None, None) , 0 , )),
	(( 'IsPublic' , 'IsPublic' , ), 1610743811, (1610743811, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 40 , (3, 0, None, None) , 0 , )),
	(( 'IsActive' , 'IsActive' , ), 1610743812, (1610743812, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 44 , (3, 0, None, None) , 0 , )),
	(( 'IsActive' , 'IsActive' , ), 1610743812, (1610743812, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 48 , (3, 0, None, None) , 0 , )),
	(( 'IsSubscribed' , 'IsSubscribed' , ), 1610743814, (1610743814, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( 'IsSubscribed' , 'IsSubscribed' , ), 1610743814, (1610743814, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
	(( 'ClientHandle' , 'ClientHandle' , ), 1610743816, (1610743816, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
	(( 'ClientHandle' , 'ClientHandle' , ), 1610743816, (1610743816, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 64 , (3, 0, None, None) , 0 , )),
	(( 'ServerHandle' , 'ServerHandle' , ), 1610743818, (1610743818, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 68 , (3, 0, None, None) , 0 , )),
	(( 'LocaleID' , 'LocaleID' , ), 1610743819, (1610743819, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 72 , (3, 0, None, None) , 0 , )),
	(( 'LocaleID' , 'LocaleID' , ), 1610743819, (1610743819, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 76 , (3, 0, None, None) , 0 , )),
	(( 'TimeBias' , 'TimeBias' , ), 1610743821, (1610743821, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 80 , (3, 0, None, None) , 0 , )),
	(( 'TimeBias' , 'TimeBias' , ), 1610743821, (1610743821, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 84 , (3, 0, None, None) , 0 , )),
	(( 'DeadBand' , 'DeadBand' , ), 1610743823, (1610743823, (), [ (16388, 10, None, None) , ], 1 , 2 , 4 , 0 , 88 , (3, 0, None, None) , 0 , )),
	(( 'DeadBand' , 'DeadBand' , ), 1610743823, (1610743823, (), [ (4, 1, None, None) , ], 1 , 4 , 4 , 0 , 92 , (3, 0, None, None) , 0 , )),
	(( 'UpdateRate' , 'UpdateRate' , ), 1610743825, (1610743825, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 96 , (3, 0, None, None) , 0 , )),
	(( 'UpdateRate' , 'UpdateRate' , ), 1610743825, (1610743825, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 100 , (3, 0, None, None) , 0 , )),
	(( 'OPCItems' , 'ppItems' , ), 0, (0, (), [ (16393, 10, None, "IID('{8A360CA7-F8D5-4A92-AB3C-D5DD4BF630F4}')") , ], 1 , 2 , 4 , 0 , 104 , (3, 0, None, None) , 0 , )),
	(( 'SyncRead' , 'Source' , 'NumItems' , 'ServerHandles' , 'Values' , 
			 'Errors' , 'Qualities' , 'TimeStamps' , ), 1610743828, (1610743828, (), [ (2, 1, None, None) , 
			 (3, 1, None, None) , (24579, 1, None, None) , (24588, 2, None, None) , (24579, 2, None, None) , (16396, 18, None, None) , 
			 (16396, 18, None, None) , ], 1 , 1 , 4 , 2 , 108 , (3, 0, None, None) , 0 , )),
	(( 'SyncWrite' , 'NumItems' , 'ServerHandles' , 'Values' , 'Errors' , 
			 ), 1610743829, (1610743829, (), [ (3, 1, None, None) , (24579, 1, None, None) , (24588, 1, None, None) , (24579, 2, None, None) , ], 1 , 1 , 4 , 0 , 112 , (3, 0, None, None) , 0 , )),
	(( 'AsyncRead' , 'NumItems' , 'ServerHandles' , 'Errors' , 'TransactionID' , 
			 ...
			 (3, 1, None, None) , (16387, 2, None, None) , ], 1 , 1 , 4 , 0 , 116 , (3, 0, None, None) , 0 , )),
	(( 'AsyncWrite' , 'NumItems' , 'ServerHandles' , 'Values' , 'Errors' , 
			 ...
			 (24588, 1, None, None) , (24579, 2, None, None) , (3, 1, None, None) , (16387, 2, None, None) , ], 1 , 1 , 4 , 0 , 120 , (3, 0, None, None) , 0 , )),
	...
	(( 'AsyncCancel' , 'CancelID' , ), 1610743833, (1610743833, (), [ (3, 1, None, None) , ], 1 , 1 , 4 , 0 , 128 , (3, 0, None, None) , 0 , )),
]

IOPCGroups_vtables_dispatch_ = 1
IOPCGroups_vtables_ = [
	(( 'Parent' , 'ppParent' , ), 1610743808, (1610743808, (), [ (16393, 10, None, "IID('{CAB0C53A-E6A6-4223-8AA2-14CAD6F14A3E}')") , ], 1 , 2 , 4 , 0 , 28 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupIsActive' , 'DefaultGroupIsActive' , ), 1610743809, (1610743809, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 32 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupIsActive' , 'DefaultGroupIsActive' , ), 1610743809, (1610743809, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 36 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupUpdateRate' , 'DefaultGroupUpdateRate' , ), 1610743811, (1610743811, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 40 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupUpdateRate' , 'DefaultGroupUpdateRate' , ), 1610743811, (1610743811, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 44 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupDeadband' , 'DefaultGroupDeadband' , ), 1610743813, (1610743813, (), [ (16388, 10, None, None) , ], 1 , 2 , 4 , 0 , 48 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupDeadband' , 'DefaultGroupDeadband' , ), 1610743813, (1610743813, (), [ (4, 1, None, None) , ], 1 , 4 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupLocaleID' , 'DefaultGroupLocaleID' , ), 1610743815, (1610743815, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupLocaleID' , 'DefaultGroupLocaleID' , ), 1610743815, (1610743815, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupTimeBias' , 'DefaultGroupTimeBias' , ), 1610743817, (1610743817, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 64 , (3, 0, None, None) , 0 , )),
	(( 'DefaultGroupTimeBias' , 'DefaultGroupTimeBias' , ), 1610743817, (1610743817, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 68 , (3, 0, None, None) , 0 , )),
	(( 'Count' , 'Count' , ), 1610743819, (1610743819, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 72 , (3, 0, None, None) , 0 , )),
	(( '_NewEnum' , 'ppUnk' , ), -4, (-4, (), [ (16397, 10, None, None) , ], 1 , 2 , 4 , 0 , 76 , (3, 0, None, None) , 1 , )),
	(( 'Item' , 'ItemSpecifier' , 'ppGroup' , ), 0, (0, (), [ (12, 1, None, None) , 
			 (16397, 10, None, "IID('{DFE64768-CCD1-4576-A47D-05ACA1E69CED}')") , ], 1 , 1 , 4 , 0 , 80 , (3, 0, None, None) , 0 , )),
	(( 'Add' , 'Name' , 'ppGroup' , ), 1610743822, (1610743822, (), [ (12, 17, None, None) , 
			 (16397, 10, None, "IID('{DFE64768-CCD1-4576-A47D-05ACA1E69CED}')") , ], 1 , 1 , 4 , 1 , 84 , (3, 0, None, None) , 0 , )),
	(( 'GetOPCGroup' , 'ItemSpecifier' , 'ppGroup' , ), 1610743823, (1610743823, (), [ (12, 1, None, None) , 
			 (16397, 10, None, "IID('{DFE64768-CCD1-4576-A47D-05ACA1E69CED}')") , ], 1 , 1 , 4 , 0 , 88 , (3, 0, None, None) , 0 , )),
	(( 'RemoveAll' , ), 1610743824, (1610743824, (), [ ], 1 , 1 , 4 , 0 , 92 , (3, 0, None, None) , 0 , )),
	(( 'Remove' , 'ItemSpecifier' , ), 1610743825, (1610743825, (), [ (12, 1, None, None) , ], 1 , 1 , 4 , 0 , 96 , (3, 0, None, None) , 0 , )),
	(( 'ConnectPublicGroup' , 'Name' , 'ppGroup' , ), 1610743826, (1610743826, (), [ (8, 1, None, None) , 
			 (16397, 10, None, "IID('{DFE64768-CCD1-4576-A47D-05ACA1E69CED}')") , ], 1 , 1 , 4 , 0 , 100 , (3, 0, None, None) , 0 , )),
	(( 'RemovePublicGroup' , 'ItemSpecifier' , ), 1610743827, (1610743827, (), [ (12, 1, None, None) , ], 1 , 1 , 4 , 0 , 104 , (3, 0, None, None) , 0 , )),
]

OPCBrowser_vtables_dispatch_ = 1
OPCBrowser_vtables_ = [
	(( 'Organization' , 'Organization' , ), 1610743808, (1610743808, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 28 , (3, 0, None, None) , 0 , )),
	(( 'Filter' , 'Filter' , ), 1610743809, (1610743809, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 32 , (3, 0, None, None) , 0 , )),
	(( 'Filter' , 'Filter' , ), 1610743809, (1610743809, (), [ (8, 1, None, None) , ], 1 , 4 , 4 , 0 , 36 , (3, 0, None, None) , 0 , )),
	(( 'DataType' , 'DataType' , ), 1610743811, (1610743811, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 40 , (3, 0, None, None) , 0 , )),
	(( 'DataType' , 'DataType' , ), 1610743811, (1610743811, (), [ (2, 1, None, None) , ], 1 , 4 , 4 , 0 , 44 , (3, 0, None, None) , 0 , )),
	(( 'AccessRights' , 'AccessRights' , ), 1610743813, (1610743813, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 48 , (3, 0, None, None) , 0 , )),
	(( 'AccessRights' , 'AccessRights' , ), 1610743813, (1610743813, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( 'CurrentPosition' , 'CurrentPosition' , ), 1610743815, (1610743815, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
	(( 'Count' , 'Count' , ), 1610743816, (1610743816, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
	...
	(( 'ShowLeafs' , 'Flat' , ), 1610743820, (1610743820, (), [ (12, 17, None, None) , ], 1 , 1 , 4 , 1 , 76 , (3, 0, None, None) , 0 , )),
	(( 'MoveUp' , ), 1610743821, (1610743821, (), [ ], 1 , 1 , 4 , 0 , 80 , (3, 0, None, None) , 0 , )),
	(( 'MoveToRoot' , ), 1610743822, (1610743822, (), [ ], 1 , 1 , 4 , 0 , 84 , (3, 0, None, None) , 0 , )),
	(( 'MoveDown' , 'Branch' , ), 1610743823, (1610743823, (), [ (8, 1, None, None) , ], 1 , 1 , 4 , 0 , 88 , (3, 0, None, None) , 0 , )),
	(( 'MoveTo' , 'Branches' , ), 1610743824, (1610743824, (), [ (24584, 1, None, None) , ], 1 , 1 , 4 , 0 , 92 , (3, 0, None, None) , 0 , )),
...
OPCItem_vtables_ = [
	(( 'Parent' , 'Parent' , ), 1610743808, (1610743808, (), [ (16397, 10, None, "IID('{DFE64768-CCD1-4576-A47D-05ACA1E69CED}')") , ], 1 , 2 , 4 , 0 , 28 , (3, 0, None, None) , 0 , )),
	(( 'ClientHandle' , 'ClientHandle' , ), 1610743809, (1610743809, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 32 , (3, 0, None, None) , 0 , )),
	(( 'ClientHandle' , 'ClientHandle' , ), 1610743809, (1610743809, (), [ (3, 1, None, None) , ], 1 , 4 , 4 , 0 , 36 , (3, 0, None, None) , 0 , )),
	(( 'ServerHandle' , 'ServerHandle' , ), 1610743811, (1610743811, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 40 , (3, 0, None, None) , 0 , )),
	(( 'AccessPath' , 'AccessPath' , ), 1610743812, (1610743812, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 44 , (3, 0, None, None) , 0 , )),
	(( 'AccessRights' , 'AccessRights' , ), 1610743813, (1610743813, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 48 , (3, 0, None, None) , 0 , )),
	(( 'ItemID' , 'ItemID' , ), 1610743814, (1610743814, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( 'IsActive' , 'IsActive' , ), 1610743815, (1610743815, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
	(( 'IsActive' , 'IsActive' , ), 1610743815, (1610743815, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
	(( 'RequestedDataType' , 'RequestedDataType' , ), 1610743817, (1610743817, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 64 , (3, 0, None, None) , 0 , )),
	(( 'RequestedDataType' , 'RequestedDataType' , ), 1610743817, (1610743817, (), [ (2, 1, None, None) , ], 1 , 4 , 4 , 0 , 68 , (3, 0, None, None) , 0 , )),
	(( 'Value' , 'CurrentValue' , ), 0, (0, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 72 , (3, 0, None, None) , 0 , )),
	(( 'Quality' , 'Quality' , ), 1610743820, (1610743820, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 76 , (3, 0, None, None) , 0 , )),
	(( 'TimeStamp' , 'TimeStamp' , ), 1610743821, (1610743821, (), [ (16391, 10, None, None) , ], 1 , 2 , 4 , 0 , 80 , (3, 0, None, None) , 0 , )),
	(( 'CanonicalDataType' , 'CanonicalDataType' , ), 1610743822, (1610743822, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 84 , (3, 0, None, None) , 0 , )),
	(( 'EUType' , 'EUType' , ), 1610743823, (1610743823, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 88 , (3, 0, None, None) , 0 , )),
	(( 'EUInfo' , 'EUInfo' , ), 1610743824, (1610743824, (), [ (16396, 10, None, None) , ], 1 , 2 , 4 , 0 , 92 , (3, 0, None, None) , 0 , )),
	(( 'Read' , 'Source' , 'Value' , 'Quality' , 'TimeStamp' , 
			 ), 1610743825, (1610743825, (), [ (2, 1, None, None) , (16396, 18, None, None) , (16396, 18, None, None) , (16396, 18, None, None) , ], 1 , 1 , 4 , 3 , 96 , (3, 0, None, None) , 0 , )),
	(( 'Write' , 'Value' , ), 1610743826, (1610743826, (), [ (12, 1, None, None) , ], 1 , 1 , 4 , 0 , 100 , (3, 0, None, None) , 0 , )),
]

OPCItems_vtables_dispatch_ = 1
OPCItems_vtables_ = [
	(( 'Parent' , 'ppParent' , ), 1610743808, (1610743808, (), [ (16397, 10, None, "IID('{DFE64768-CCD1-4576-A47D-05ACA1E69CED}')") , ], 1 , 2 , 4 , 0 , 28 , (3, 0, None, None) , 0 , )),
	(( 'DefaultRequestedDataType' , 'DefaultRequestedDataType' , ), 1610743809, (1610743809, (), [ (16386, 10, None, None) , ], 1 , 2 , 4 , 0 , 32 , (3, 0, None, None) , 0 , )),
	(( 'DefaultRequestedDataType' , 'DefaultRequestedDataType' , ), 1610743809, (1610743809, (), [ (2, 1, None, None) , ], 1 , 4 , 4 , 0 , 36 , (3, 0, None, None) , 0 , )),
	(( 'DefaultAccessPath' , 'DefaultAccessPath' , ), 1610743811, (1610743811, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 40 , (3, 0, None, None) , 0 , )),
	(( 'DefaultAccessPath' , 'DefaultAccessPath' , ), 1610743811, (1610743811, (), [ (8, 1, None, None) , ], 1 , 4 , 4 , 0 , 44 , (3, 0, None, None) , 0 , )),
	(( 'DefaultIsActive' , 'DefaultIsActive' , ), 1610743813, (1610743813, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 48 , (3, 0, None, None) , 0 , )),
	(( 'DefaultIsActive' , 'DefaultIsActive' , ), 1610743813, (1610743813, (), [ (11, 1, None, None) , ], 1 , 4 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( 'Count' , 'Count' , ), 1610743815, (1610743815, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
	(( '_NewEnum' , 'ppUnk' , ), -4, (-4, (), [ (16397, 10, None, None) , ], 1 , 2 , 4 , 0 , 60 , (3, 0, None, None) , 1 , )),
	(( 'Item' , 'ItemSpecifier' , 'ppItem' , ), 0, (0, (), [ (12, 1, None, None) , 
			 (16393, 10, None, "IID('{6CD1DF31-FCAC-45F7-9470-36F1423B5112}')") , ], 1 , 1 , 4 , 0 , 64 , (3, 0, None, None) , 0 , )),
	(( 'GetOPCItem' , 'ServerHandle' , 'ppItem' , ), 1610743818, (1610743818, (), [ (3, 1, None, None) , 
			 (16393, 10, None, "IID('{6CD1DF31-FCAC-45F7-9470-36F1423B5112}')") , ], 1 , 1 , 4 , 0 , 68 , (3, 0, None, None) , 0 , )),
	(( 'AddItem' , 'ItemID' , 'ClientHandle' , 'ppItem' , ), 1610743819, (1610743819, (), [ 
			 (8, 1, None, None) , (3, 1, None, None) , (16393, 10, None, "IID('{6CD1DF31-FCAC-45F7-9470-36F1423B5112}')") , ], 1 , 1 , 4 , 0 , 72 , (3, 0, None, None) , 0 , )),
	(( 'AddItems' , 'NumItems' , 'ItemIDs' , 'ClientHandles' , 'ServerHandles' , 
			 ...
			 (24584, 1, None, None) , (24579, 1, None, None) , (24579, 2, None, None) , (24579, 2, None, None) , (12, 17, None, None) , 
	...
	(( 'Validate' , 'NumItems' , 'ItemIDs' , 'Errors' , 'RequestedDataTypes' , 
			 ...
			 (12, 17, None, None) , (12, 17, None, None) , ], 1 , 1 , 4 , 2 , 84 , (3, 0, None, None) , 0 , )),
	(( 'SetActive' , 'NumItems' , 'ServerHandles' , 'ActiveState' , 'Errors' , 
			 ), 1610743823, (1610743823, (), [ (3, 1, None, None) , (24579, 1, None, None) , (11, 1, None, None) , (24579, 2, None, None) , ], 1 , 1 , 4 , 0 , 88 , (3, 0, None, None) , 0 , )),
	(( 'SetClientHandles' , 'NumItems' , 'ServerHandles' , 'ClientHandles' , 'Errors' , 
			 ), 1610743824, (1610743824, (), [ (3, 1, None, None) , (24579, 1, None, None) , (24579, 1, None, None) , (24579, 2, None, None) , ], 1 , 1 , 4 , 0 , 92 , (3, 0, None, None) , 0 , )),
	(( 'SetDataTypes' , 'NumItems' , 'ServerHandles' , 'RequestedDataTypes' , 'Errors' , 
			 ), 1610743825, (1610743825, (), [ (3, 1, None, None) , (24579, 1, None, None) , (24579, 1, None, None) , (24579, 2, None, None) , ], 1 , 1 , 4 , 0 , 96 , (3, 0, None, None) , 0 , )),
]
